...
class ElggWebinar extends ElggObject {
	...
	public function getServer() {
		return new BigBlueButton('adminname', $this->guid, $this->welcome_msg, $this->admin_pwd, $this->user_pwd, $this->record, $this->server_salt, $this->server_url, $this->logout_url);
	}
