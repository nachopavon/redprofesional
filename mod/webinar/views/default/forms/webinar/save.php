...
if ( elgg_is_admin_logged_in() ) {
	...
	$record_label = elgg_echo('webinar:record');
	$record_input = elgg_view('input/text', array(
			'name' => 'record',
			'id' => 'webinar_record',
			'value' => $vars['record']
	));
	...
	//Cambiado para las reuniones funcionen correctamente para los usuarios no administradores
	...
	$record_input = elgg_view('input/hidden', array('name' => 'record','id' => 'webinar_record','value' => $vars['record']));
...
//	$server_url_input = elgg_view('input/hidden', array('name' => 'webinar_server_url', 'value' => $vars['server_url']));
	if ($vars['logout_url']) {
		$logout_url_input = elgg_view('input/hidden', array('name' => 'logout_url','id' => 'webinar_logout_url', 'value' => $vars['logout_url']));
	}
	$user_bloc = $admin_pwd_input . $user_pwd_input . $record_input . $server_salt_input . $server_url_input . $logout_url_input; 
}
...
<div>
        <label for="webinar_record">$record_label</label>
        $record_input
</div>
