...
function thewire_init() {
	...
	// Register actions
	$action_base = $CONFIG->pluginspath . 'ect_thewire/actions';
...
function thewire_page_handler($page) {
	...
	$base_dir = elgg_get_plugins_path() . 'ect_thewire/pages/thewire';
 ...
 */
function thewire_save_post($text, $userid, $access_id, $parent_guid = 0, $method = "site", $trigger=TRUE) {
	$post = new ElggObject();
