...
<?php
//Cambiando cosas para que solo el administrador pueda hacer grupos invisibles
...
//	);
if ((elgg_get_plugin_setting('hidden_groups', 'groups') == 'yes') & elgg_is_admin_logged_in())
	{
        $access_options = array(
              ACCESS_PRIVATE => elgg_echo('groups:access:group'),
              ACCESS_LOGGED_IN => elgg_echo("LOGGED_IN"),
...
<?php
	...
	else if (elgg_get_plugin_setting('hidden_groups', 'groups') == 'yes') 
		{
		$access_options = array(
//              ACCESS_PRIVATE => elgg_echo('groups:access:group'),
              ACCESS_LOGGED_IN => elgg_echo("LOGGED_IN"),
