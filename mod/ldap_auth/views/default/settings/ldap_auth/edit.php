...
<p>
    <fieldset style="border: 1px solid; padding: 15px; margin: 0 10px 0 10px">
        ...
        <label for="params[start_tls]"><?php echo elgg_echo('ldap_auth:settings:label:start_tls');?></label><br/>
        <div class="example"><?php echo elgg_echo('ldap_auth:settings:help:start_tls');?></div>
