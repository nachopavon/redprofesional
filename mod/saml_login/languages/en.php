...
$english = array(
	...
	'saml_login:update_userdata' => 'Update elgg user accounts with the data from the IdP accounts in each log in?',
        'saml_login:support_groups' => 'Support SAML groups',
        'saml_login:groupfield' => 'The attribute with the group info',
	'saml_login:config:group_mapping_error' => 'There was a problem with the group_mapping.php file',
        'saml_login:sync_groups' => 'Sync groups of the user with data recieved from IdP (ill-advised due will not allow user keep groups not registered at the IdP)'
);
