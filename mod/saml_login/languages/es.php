...
$spanish = array(
	...
	'saml_login:support_groups' => 'Soporte para grupos',
	'saml_login:groupfield' => 'El atributo de la aserción SAML con la información de los grupos',
	'saml_login:config:group_mapping_error' => 'Hay un problema con el archivo group_mapping',
	'saml_login:sync_groups' => 'Sincronizar los grupos del usuario con los datos recibidos del IdP (desaconsejado ya que no permitira al usuario tener grupos diferentes a los establecidos en el IdP'
);
