...
//		elgg_register_simplecache_view('js/towtruck/towtruck.js');
		//URL para towtruck
//		$url = elgg_get_simplecache_url('js', 'towtruck/towtruck.js');
		// register JS library
	...
	//	elgg_register_js('towtruck', elgg_get_site_url() . "mod/pages_tools/vendors/towtruck/towtruck.js");
