...
//			elgg_extend_view("page/layout/content/sidebar", "widgets/profile_completeness/content");
...
//		elgg_extend_view('page/layouts/content/sidebar', 'page/layout/content/sidebar');
